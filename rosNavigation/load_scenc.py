...
from dataloader import VLMapsDataloaderHabitat
from ros_navigator import Navigator

from map_utils import get_bbox, find_similar_category_id
from gml_floor_4_lab import gml4cat
from lang_agent import LangRobot
...
class HabitatLanguageRobot(LangRobot):
    ...
    def setup_map(self, vlmaps_data_dir: str):
        ...
        if "3d" in self.config.map_config.map_type:
            self.map.init_categories(gml4cat.copy())
